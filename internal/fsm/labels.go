...
const (
	EvStartRinse     PlantEvent = "start_rinse"
	EvRinseComplete  PlantEvent = "rinse_complete"
...
func StateLabel(s model.PlantState) string {
	...
	case model.StateColdStandby:
		return "Cold Standby"
	case model.StateRinse:
		return "Beltframe Rinse"
...
func EventLabel(e PlantEvent) string {
	...
	case EvStartRinse:
		return "Start Rinse"
	case EvRinseComplete:
		return "Rinse Complete"
	case EvIgnite:
		return "Ignite"
