...
import (
	...
	"github.com/lacsar712/pasteur/internal/web"
	"github.com/lacsar712/pasteur/internal/web/api"
)
...
func main() {
	...
	go func() {
		log.Printf("pasteur listening on %s (unit %s)", cfg.ListenAddr, application.UnitID())
